(function(){
  ...
  function renderFutureReviewSchedule(){
    ...
    var tomorrowCount=ps.filter(function(p){return p.status==='pending'&&p.next_review_date===tomorrow}).length;
    var dayAfterCount=ps.filter(function(p){return p.status==='pending'&&p.next_review_date===dayAfter}).length;
